...
//
const validateTime = module.exports.validateTime = (time/*: string*/)/*: boolean*/ => {
...
// 12            December             31
//
const validateDate = module.exports.validateDate = (datestring/*: string*/)/*: boolean*/ => {
...
// Where *s is a fraction of seconds with at least 1 digit.
//
module.exports.validateDateTime = (dateTimeString/*: string*/)/*: boolean*/ => {
...
//
module.exports.validateUnixTimestamp = (timestamp/*: number*/)/*: boolean*/ => {
...
// is valid.
//
module.exports.validateJSDate = (date/*: Date*/)/*: boolean*/ => {
